...
export default function Home() {
    return (<div>
        ...
        <Objective
            ...
            tags={['Engineering', 'Compter Science', 'Passion', 'Creative Mind', 'Critical Thinking', 'Perseverance']}
        />
        <Objective
            ...
            tags={['Desire to Develop', 'DSA Addiction', 'Satisfaction', 'Complex Tasks Bias']}
        />
    </div>)
}